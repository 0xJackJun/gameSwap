...
import './interfaces/IGameERC20.sol';
import './libraries/SafeMath.sol';

contract GameERC20 is IGameERC20 {
    using SafeMath for uint;

    string public override constant name = 'Game Token';
    string public override constant symbol = 'GT';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) override external {
        require(deadline >= block.timestamp, 'GameERC20: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'GameERC20: INVALID_SIGNATURE');
